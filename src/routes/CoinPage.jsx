                ...
                <div>
                    ...
                    <div className={`flex justify-between py-4`}>
                        ...
                        <div>
                            ...
                            {coin.market_data?.market_cap ? (
                                <p>${coin.market_data.total_volume.usd.toLocaleString()}</p>) : null}
                        </div>
                    </div>
                    <div className={`flex justify-between py-4`}>
                        <div>
                ...
                <div>
                    ...
                    <div className={`flex justify-between py-4`}>
                        <div>
                            ...
                            {coin.market_data ? (
                                <p>{coin.market_data.price_change_percentage_24h.toFixed(2)}%</p>) : null}
                        </div>
                        <div>
                            <p className={`text-gray-500 text-sm`}>Price change 7d</p>
                            {coin.market_data ? (
                                <p>{coin.market_data.price_change_percentage_7d.toFixed(2)}%</p>) : null}
                        </div>
                        <div>
                            <p className={`text-gray-500 text-sm`}>Price change 14d</p>
                            {coin.market_data ? (
                                <p>{coin.market_data.price_change_percentage_14d.toFixed(2)}%</p>) : null}
                        </div>
                    </div>
                    <div className={`flex justify-between py-4`}>
                        <div>
                            ...
                            {coin.market_data ? (
                                <p>{coin.market_data.price_change_percentage_30d.toFixed(2)}%</p>) : null}
                        </div>
                        <div>
                            <p className={`text-gray-500 text-sm`}>Price change (60d)</p>
                            {coin.market_data ? (
                                <p>{coin.market_data.price_change_percentage_60d.toFixed(2)}%</p>) : null}
                        </div>
                        <div>
                            <p className={`text-gray-500 text-sm`}>Price change (1y)</p>
                            {coin.market_data ? (
                                <p>{coin.market_data.price_change_percentage_1y.toFixed(2)}%</p>) : null}
                        </div>
                    </div>
