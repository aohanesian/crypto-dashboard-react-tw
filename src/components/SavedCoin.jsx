...
function SavedCoin(props) {
    ...
    return (
        <div>
            {coins?.length === 0 ? (<p>
                You don`t have any coins saved. Please save a coin to add it to your watch list. <Link to={`/`}>Click
                here to search coins</Link>
            </p>) : (
                        ...
                        <tr key={coin.id} className={`h-[60px] overflow-hidden`}>
                            ...
                            <td>{<Link to={`/coin/${coin.id}`}>
                                <div>
                                    ...
                                    <div>
                                        <p className={`hidden sm:table-celll`}>{coin?.name}</p>
